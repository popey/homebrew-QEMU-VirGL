class QemuVirgl < Formula
  ...
  depends_on "gnutls"
  depends_on "jpeg"
  depends_on "popey/qemu-virgl/libangle"
  depends_on "popey/qemu-virgl/libepoxy-angle"
  depends_on "popey/qemu-virgl/virglrenderer"
  depends_on "libpng"
  depends_on "libssh"
  depends_on "libusb"
  depends_on "lzo"
  ...
  patch :p1 do
    url "https://raw.githubusercontent.com/popey/homebrew-qemu-virgl/87072b7ccc07f5087bf0848fa8920f8b3f8d5a47/Patches/qemu-v05.diff"
